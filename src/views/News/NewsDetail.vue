<template>
    <div>
        ...
        <div class="flex flex-col items-start gap-5 border-b border-gray pb-7 mb-7 sm:flex-row sm:items-center">
            ...
            <h2 class="font-bold text-xl">假標題假標題假標題假標題假標題</h2>
        </div>
        <div class="pb-24 border-b border-gray mb-16">
            <p class="mb-7">假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容假內容</p>
            <div class="flex">
                <img class="w-1/2" src="../../assets/image/news/news05.png" alt="">
                <img class="w-1/2" src="../../assets/image/news/news06.png" alt="">
            </div>
        </div>
        <div class="text-center">
            <RouterLink to="/news" class="inline-block mb-20 buttonStyle" type="button">返回列表</RouterLink>
        </div>
    </div>
</template>